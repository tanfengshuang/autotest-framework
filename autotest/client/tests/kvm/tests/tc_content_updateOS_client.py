...
def run_tc_content_updateOS_client(test, params, env):
        ...
        try:
                try:
                        ...
                        if 'RHEL-Client-6.4' in guestname:
                                refer_redhat_release = 'Red Hat Enterprise Linux Client release 6.5 (Santiago)'
                                refer_kernel_version = 'kernel-2.6.32-358.2.1.el6'
                        elif 'RHEL-Client-5.9' in guestname:
                                #refer_redhat_release = 'Red Hat Enterprise Linux Client release 5.10 (Tikanga)'
                                refer_redhat_release = 'Red Hat Enterprise Linux Client release 5.10 Beta (Tikanga)'
