...
def run_tc_content_hightouchbeta(test, params, env):
	...
	try:
		try:         
	                ...
	                if ("stage" in hostname):
	                	username = "stage_test_34"
	                	password = "redhat"
	                	sku = "RH2424237,RH0103708"
	                else:
			...
			ep().cnt_rhel_test(session, vm, username, password, prodsku, basesku, productid, content_level, "", release_list)
