...
def run_tc_content_updateOS_ppc64(test, params, env):
		...
		try:     
			...
			#[A]Prepare test data
	                guestname = params.get("guest_name")
                        ...
                        if 'RHEL-Server-ppc64-6.4' in guestname:
				...
				dkey = 'RHEL-Server-6.4_64_url'
                        elif 'RHEL-Server-ppc64-5.9' in guestname:
                                #refer_redhat_release = 'Red Hat Enterprise Linux Server release 5.10 (Tikanga)'
				...
				dkey = 'RHEL-Server-5.9_64_url'
                                ...
                                refer_redhat_release = 'Red Hat Enterprise Linux Server release 6.5 Beta (Tikanga)'
                                refer_kernel_version = 'kernel-2.6.18-363.el5xen'
