...
def run_tc_SKU_consistency_verify_attributes_reference(test, params, env):
	...
	try:         
		...
		sku_regression_attributes_desc = os.path.join(desc_path, "entitlement_sku_regression_attributes_test.desc") 
