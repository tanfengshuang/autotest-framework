...
def run_tc_content_resilientstorage(test, params, env):
	...
	try:
		try:    
			...
			hostname = params.get("hostname")
					...
					username = 'stage_test_37_new'
					password = 'redhat'
					sku = "RH1316844,RH0586408"
				else:
					username = 'stage_test_37_new'
					password = 'redhat'
					sku = "RH1316844,RH0103708"
			else:
				username = ee.username_qa
				password = ee.password_qa
				if "ppc64" in guest_name:
					sku = "SYS0395,RH0350482"
				else:
					sku = "SYS0395"
			productid_cont = '90'
