...
def run_tc_content_server_rhui(test, params, env):
	...
	try:
		try:     
			...
			ep().cnt_rhel_test(session, vm, username, password, prodsku, basesku, productid_cont, content_level, type_rhui, release_list)
