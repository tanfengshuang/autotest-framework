...
def run_tc_content_updateOS_workstation(test, params, env):
        ...
        try:
                try:
                        ...
                        if 'RHEL-Workstation-6.4' in guestname:
                                refer_redhat_release = 'Red Hat Enterprise Linux Workstation release 6.5 (Santiago)'
                                refer_kernel_version = 'kernel-2.6.32-358.2.1.el6'
                        elif 'RHEL-Workstation-5.9' in guestname:
